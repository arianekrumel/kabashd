module DemoHelper
    ...
    class DemoGame < GameSkeleton
        def initialize(user_state)
            ...
            DemoGame.initialize_actions_to_response_narrator
            DemoGame.initialize_actions_to_response_nurse
            DemoGame.initialize_actions_to_response_watson
            DemoGame.initialize_actions_to_response_patient
            DemoGame.initialize_percent_per_action
            DemoGame.initialize_bad_response_to_state
        end
